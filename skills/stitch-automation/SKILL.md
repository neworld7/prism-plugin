...
Stitch 디자인을 기존 코드에 반영하는 **UI 리스킨 파이프라인**.
**핵심: 기능(상태관리, API, 네비게이션)은 보존하고 UI/레이아웃만 Stitch에 맞게 변경한다.**
...
| React component conversion | `references/official/react-components/` |
