# Stitch Automation Plugin Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-03-17-stitch-plugin-design.md`
...
| `commands/stitch.md` | `/stitch` slash command with all subcommands |
| `skills/stitch-automation/SKILL.md` | Skill activation, core workflows, critical patterns |
| `skills/stitch-automation/references/tools.md` | 14 MCP tools reference with params and usage |
| `skills/stitch-automation/references/prompting.md` | Stitch prompting guide |
| `skills/stitch-automation/references/workflows-design.md` | Code→Design pipeline Phase 1-7 |
| `skills/stitch-automation/references/workflows-implement.md` | Design→Code pipeline Phase 1-7 |
| `skills/stitch-automation/references/sheet-template.md` | Design/implement sheet markdown template |
...
git commit -m "feat: add plugin manifest files for stitch-automation"
```
...
- State file path: `.claude/stitch-design-pipeline.local.md` (was `.claude/design-pipeline.local.md`)
...
Key changes:
- State file path: `.claude/stitch-implement-pipeline.local.md` (was `.claude/design-to-code.local.md`)
...
**Files:**
- Create: `skills/stitch-automation/SKILL.md`
...
**Files:**
- Create: `skills/stitch-automation/references/tools.md`
...
**Files:**
- Create: `skills/stitch-automation/references/prompting.md`
...
**Files:**
- Create: `skills/stitch-automation/references/workflows-design.md`
...
**Files:**
- Create: `skills/stitch-automation/references/workflows-implement.md`
...
3. For each screen:
   ...
   web_fetch(downloadUrl.html) → save HTML to /tmp/stitch-{screenName}.html
   web_fetch(downloadUrl.screenshot) → save image to /tmp/stitch-{screenName}.png
```
...
**Files:**
- Create: `skills/stitch-automation/references/sheet-template.md`
...
1. **Design sheet** (for `/stitch design` pipeline)
2. **Implement sheet** (for `/stitch implement` pipeline)
...
### Task 10: /stitch Slash Command

**Files:**
- Create: `commands/stitch.md`
...
git commit -m "feat: add /stitch slash command with all subcommands"
```
...
./skills/stitch-automation/SKILL.md
./skills/stitch-automation/references/prompting.md
./skills/stitch-automation/references/sheet-template.md
./skills/stitch-automation/references/tools.md
./skills/stitch-automation/references/workflows-design.md
./skills/stitch-automation/references/workflows-implement.md
```
