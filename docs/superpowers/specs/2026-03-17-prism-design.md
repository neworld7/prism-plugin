...
|---------|----------|---------------|
| `/loom design [feature]` | Code→Design full pipeline | `create_project`, `generate_screen_from_text`, `create_design_system` |
| `/loom implement [feature]` | Design→Code full pipeline | `list_projects`, `get_screen` + `web_fetch` |
| `/loom verify-loop` | Design verify loop standalone | `get_screen` + `web_fetch`, `edit_screens` |
| `/loom code-verify-loop` | Code verify loop standalone | `get_screen` + `web_fetch` |
| `/loom cancel-loop` | Cancel active loop (deletes state files) | — |
| `/loom status` | Show current pipeline state | — (reads state file) |
| `/loom create` | Create project or screen | `create_project`, `generate_screen_from_text` |
| `/loom edit` | Edit screen | `edit_screens` |
| `/loom variants` | Generate design variants | `generate_variants` |
| `/loom theme` | Create/apply design system | `create_design_system`, `apply_design_system` |
| `/loom export` | Download screen HTML/image | `get_screen` + `web_fetch` |
| `/loom list` | List projects/screens | `list_projects`, `list_screens` |

## Pipeline 1: Code→Design (`/loom design`)
...
### State File: `.claude/loom-design-pipeline.local.md`
...
## Pipeline 2: Design→Code (`/loom implement`)
...
### State File: `.claude/loom-implement-pipeline.local.md`
...
- Check if `.claude/loom-design-pipeline.local.md` exists
...
### code-verify-stop.sh
- Check if `.claude/loom-implement-pipeline.local.md` exists
- Read YAML frontmatter: phase, iteration, max_iterations
...
- `/loom cancel-loop` → deletes both `.claude/loom-design-pipeline.local.md` and `.claude/loom-implement-pipeline.local.md`
